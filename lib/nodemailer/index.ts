...
export const generateEmailBody = (product: EmailProductInfo, type: NotificationType) => {
    ...
    ? `${product.title.substring(0,20)}...` : product.title;
    ...
    switch (type) {
        case Notification.WELCOME:
            ...
            body = `
                <div>
                  <h2>Welcome to PriceWise 🚀 | by Akash Kumar (IIT ISM DHANBAD)</h2>
...
const transporter = nodemailer.createTransport({
    ...
    port:2525,
    auth: {
        user: 'pricewiseofficial23@outlook.com',
...
export const sendEmail = async (emailContent: EmailContent, sendTo: string[])=>{
    const mailOptions = {
        from: 'pricewiseofficial23@outlook.com',
        to: sendTo,
